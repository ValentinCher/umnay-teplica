    ...
    <div class="col">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="mb-2"><a href="/felts-journal" class="btn w-100 btn-success">Журнал удобрения</a></div>
                <div class="mb-2"><a href="/grow" class="btn w-100 btn-primary">Журнал хода выращивания</a></div>
                <div class="mb-2"><a href="/water-journal" class="btn w-100 btn-warning">Журнал полива</a></div>
            </div>
        </div>
    </div>
    <div class="col">
